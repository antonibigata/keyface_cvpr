...
class CrossAttention(nn.Module):
    ...
    def forward(
        ...
        combined_out = torch.zeros((x.shape[0], out.shape[1], out.shape[2]), dtype=out.dtype, device=out.device)
...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        if self.checkpoint:
            ...
            return checkpoint(self._forward, x, context, reference_context, None, 0, skip_attention)
